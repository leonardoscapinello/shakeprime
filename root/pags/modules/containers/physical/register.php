...
if ($user !== null && $user !== "") {
    ...
    header("location: " . $this->getModuleURLByKey("P00003") . "?startAnalysis=Y");
    die();
}
?>
        ...
        <div class="widget">
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-xl-12">
                    <div class="form_input">
                        <input autocomplete="off" type="text" disabled value="<?= $name; ?>"
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-xl-6">
                    <div class="form_input">
                        <input autocomplete="off" type="text" class="phone_with_ddd" disabled
                               value="<?= $phone; ?>"
                ...
                <div class="col-sm-12 col-lg-12 col-xl-6">
                    <div class="form_input">
                        <input autocomplete="off" type="text" disabled class="mobile"
                               value="<?= $mobile; ?>"
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-xl-8">
                    <div class="form_input">
                        <input autocomplete="off" type="text" disabled value="<?= $email; ?>"
                ...
                <div class="col-sm-12 col-lg-12 col-xl-4">
                    <div class="form_input">
                        <input autocomplete="off" type="text" disabled class="date"
                               value="<?= $birthday; ?>"
